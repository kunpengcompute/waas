# User Guide<a name="EN-US_TOPIC_0000002550231305"></a>
...
[Table 1](#table4329191513444)  describes the WAAS Booster directory and file permissions for RPM-based deployment.
...
[Table 2](#table3466147344)  describes the WAAS Booster directory and file permissions for deployment using Kubernetes pods.
