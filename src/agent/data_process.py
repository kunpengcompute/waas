...
class DataProcessor:
    features = {
        ...
        "l1d.refer/l1i.refer": _div(
            "L1D_CACHE",
            "L1I_CACHE",
        ),
        "l1d.refer/tlb1d.refer": _div(
            "L1D_CACHE",
            "L1D_TLB",
        ),
        "branch.mr": _div(
